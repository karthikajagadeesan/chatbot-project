...
export default function SuperAdminMobileHeader() {
                            ...
                            <Button variant="ghost" className="relative h-9 w-9 rounded-full">
                                <Avatar className="h-9 w-9">
                                    <AvatarFallback className="bg-primary text-primary-foreground capitalize">
                                        {superadmin?.first_name ? getInitials(superadmin.first_name) : "G"}
                                    </AvatarFallback>
                                </Avatar>
                            </Button>
                        </DropdownMenuTrigger>
                            ...
                            <DropdownMenuLabel className="font-normal">
                                <div className="flex flex-col space-y-1">
                                    <p className="text-sm font-medium leading-none capitalize">
                                        {superadmin?.first_name + " " + superadmin?.last_name || "Guest"}
                                    </p>
                                    <p className="text-xs leading-none text-muted-foreground">
                                        {superadmin?.email || "No email"}
                                    </p>
                                </div>
                            </DropdownMenuLabel>
                            <DropdownMenuSeparator />
